...
Console.WriteLine("Pengurangan: " + var1 + " - " + var2 + " = " + Penjumlahan(var1, var2));
Console.WriteLine("Perkalian: " + var1 + " * " + var2 + " = " + Penjumlahan(var1, var2));
Console.WriteLine("Pembagian: " + var1 + " / " + var2 + " = " + Penjumlahan(var1, var2));
